package org.example.jiwoo_coin_demo.contracts;
...
public class Jiwoo_coin extends Contract {
    ...
    @Deprecated
    protected Jiwoo_coin(String contractAddress, Web3j web3j, TransactionManager transactionManager,
            BigInteger gasPrice, BigInteger gasLimit) {
    ...
    @Deprecated
    public static Jiwoo_coin load(String contractAddress, Web3j web3j, Credentials credentials,
            BigInteger gasPrice, BigInteger gasLimit) {
        return new Jiwoo_coin(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static Jiwoo_coin load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new Jiwoo_coin(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static Jiwoo_coin load(String contractAddress, Web3j web3j, Credentials credentials,
            ContractGasProvider contractGasProvider) {
        return new Jiwoo_coin(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static Jiwoo_coin load(String contractAddress, Web3j web3j,
            TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new Jiwoo_coin(contractAddress, web3j, transactionManager, contractGasProvider);
    }
